...
<figure style={{textAlign: 'center', margin: '0 0 1rem'}}>
  <img src={require('./images/airylite485/image_9.png').default} alt="Wiring diagram of AiryLite LiDAR connected to the adapter board and the host via USB" style={{maxWidth: '600px', width: '100%', height: 'auto'}} />
  <figcaption style={{fontSize: '0.85em', color: 'var(--ifm-color-emphasis-600)', marginTop: '0.4rem'}}>Figure 1: LiDAR connection diagram</figcaption>
</figure>
...
<figure style={{textAlign: 'center', margin: '0 0 1rem'}}>
  <img src={require('./images/airylite485/image_2.png').default} alt="CH343 serial port driver download page" style={{maxWidth: '600px', width: '100%', height: 'auto'}} />
  <figcaption style={{fontSize: '0.85em', color: 'var(--ifm-color-emphasis-600)', marginTop: '0.4rem'}}>Figure 2: Downloading the serial port driver</figcaption>
</figure>

<figure style={{textAlign: 'center', margin: '0 0 1rem'}}>
  <img src={require('./images/airylite485/image_6.png').default} alt="Running the CH343 driver installer executable" style={{maxWidth: '600px', width: '100%', height: 'auto'}} />
  <figcaption style={{fontSize: '0.85em', color: 'var(--ifm-color-emphasis-600)', marginTop: '0.4rem'}}>Figure 3: Running the installer</figcaption>
</figure>

<figure style={{textAlign: 'center', margin: '0 0 1rem'}}>
  <img src={require('./images/airylite485/img_v3_02vl_c1a3d2ac-53ed-4d11-9c27-7870110b256g.png').default} alt="CH343 driver installation window showing installation in progress" style={{maxWidth: '600px', width: '100%', height: 'auto'}} />
  <figcaption style={{fontSize: '0.85em', color: 'var(--ifm-color-emphasis-600)', marginTop: '0.4rem'}}>Figure 4: Installing the serial port driver</figcaption>
</figure>
...
<figure style={{textAlign: 'center', margin: '0 0 1rem'}}>
  <img src={require('./images/airylite485/image_11.png').default} alt="Windows Device Manager listing five COM ports including SERIAL-A and SERIAL-D" style={{maxWidth: '600px', width: '100%', height: 'auto'}} />
  <figcaption style={{fontSize: '0.85em', color: 'var(--ifm-color-emphasis-600)', marginTop: '0.4rem'}}>Figure 5: Checking the ports in Device Manager</figcaption>
</figure>
...
<figure style={{textAlign: 'center', margin: '0 0 1rem'}}>
  <img src={require('./images/airylite485/image_3.png').default} alt="Terminal output of udevadm monitor showing the ttyCH343USB serial port nodes" style={{maxWidth: '600px', width: '100%', height: 'auto'}} />
  <figcaption style={{fontSize: '0.85em', color: 'var(--ifm-color-emphasis-600)', marginTop: '0.4rem'}}>Figure 6: The high-speed serial ports are ttyCH343USB0 and ttyCH343USB3</figcaption>
</figure>
...
<figure style={{textAlign: 'center', margin: '0 0 1rem'}}>
  <img src={require('./images/airylite485/image_1.png').default} alt="RSView Sensor Network Config dialog with serial port names and baud rate filled in" style={{maxWidth: '600px', width: '100%', height: 'auto'}} />
  <figcaption style={{fontSize: '0.85em', color: 'var(--ifm-color-emphasis-600)', marginTop: '0.4rem'}}>Figure 7: Filling in the configuration parameters</figcaption>
</figure>
...
<figure style={{textAlign: 'center', margin: '0 0 1rem'}}>
  <img src={require('./images/airylite485/image_10.png').default} alt="RSView Sensor Type selection dialog with 0352_4M selected on Windows" style={{maxWidth: '600px', width: '100%', height: 'auto'}} />
  <figcaption style={{fontSize: '0.85em', color: 'var(--ifm-color-emphasis-600)', marginTop: '0.4rem'}}>Figure 8: Selecting the LiDAR type</figcaption>
</figure>
...
<figure style={{textAlign: 'center', margin: '0 0 1rem'}}>
  <img src={require('./images/airylite485/image_8.png').default} alt="RSView Sensor Type selection dialog with 0352_4M selected on Ubuntu" style={{maxWidth: '600px', width: '100%', height: 'auto'}} />
  <figcaption style={{fontSize: '0.85em', color: 'var(--ifm-color-emphasis-600)', marginTop: '0.4rem'}}>Figure 9: Selecting the LiDAR type</figcaption>
</figure>
...
<figure style={{textAlign: 'center', margin: '0 0 1rem'}}>
  <img src={require('./images/airylite485/image_12.png').default} alt="RSView Sensor Network Config dialog on Ubuntu with serial port names and baud rate filled in" style={{maxWidth: '600px', width: '100%', height: 'auto'}} />
  <figcaption style={{fontSize: '0.85em', color: 'var(--ifm-color-emphasis-600)', marginTop: '0.4rem'}}>Figure 10: Filling in the configuration parameters</figcaption>
</figure>
...
<figure style={{textAlign: 'center', margin: '0 0 1rem'}}>
  <img src={require('./images/airylite485/image_7.png').default} alt="config.yaml content showing msg_source, serial port and baud rate settings" style={{maxWidth: '600px', width: '100%', height: 'auto'}} />
  <figcaption style={{fontSize: '0.85em', color: 'var(--ifm-color-emphasis-600)', marginTop: '0.4rem'}}>Figure 11: Common driver parameter configuration</figcaption>
</figure>
...
<figure style={{textAlign: 'center', margin: '0 0 1rem'}}>
  <img src={require('./images/airylite485/image.png').default} alt="Windows Defender Firewall settings page with all firewalls turned off" style={{maxWidth: '600px', width: '100%', height: 'auto'}} />
  <figcaption style={{fontSize: '0.85em', color: 'var(--ifm-color-emphasis-600)', marginTop: '0.4rem'}}>Figure 12: Turning off the firewall</figcaption>
</figure>

<figure style={{textAlign: 'center', margin: '0 0 1rem'}}>
  <img src={require('./images/airylite485/img_v3_02102_067e8142-39ab-4615-8ba4-f832656ec1dg.png').default} alt="Error message caused by invalid characters in the RSView program path on Windows" style={{maxWidth: '600px', width: '100%', height: 'auto'}} />
  <figcaption style={{fontSize: '0.85em', color: 'var(--ifm-color-emphasis-600)', marginTop: '0.4rem'}}>Figure 13: Error caused by invalid characters in the path</figcaption>
</figure>
...
<figure style={{textAlign: 'center', margin: '0 0 1rem'}}>
  <img src={require('./images/airylite485/img_v3_02uh_d43fd878-3e57-4a58-8035-8655cfabd7bg.webp').default} alt="LiDAR emitting laser observed with a camera" style={{maxWidth: '600px', width: '100%', height: 'auto'}} />
  <figcaption style={{fontSize: '0.85em', color: 'var(--ifm-color-emphasis-600)', marginTop: '0.4rem'}}>Figure 14: The LiDAR is emitting laser</figcaption>
</figure>

<figure style={{textAlign: 'center', margin: '0 0 1rem'}}>
  <img src={require('./images/airylite485/image_4.png').default} alt="Adapter board with its indicator light on" style={{maxWidth: '600px', width: '100%', height: 'auto'}} />
  <figcaption style={{fontSize: '0.85em', color: 'var(--ifm-color-emphasis-600)', marginTop: '0.4rem'}}>Figure 15: The adapter board indicator is lit</figcaption>
</figure>

3. Open Device Manager. If the computer detects the ports (5 in total) named "COM + number", the data link wiring is correct.

<figure style={{textAlign: 'center', margin: '0 0 1rem'}}>
  <img src={require('./images/airylite485/img_v3_02uh_806fd32d-7dbf-487a-8644-9b4d3606de1g.jpg').default} alt="Device Manager port list confirming the data link wiring is correct" style={{maxWidth: '600px', width: '100%', height: 'auto'}} />
  <figcaption style={{fontSize: '0.85em', color: 'var(--ifm-color-emphasis-600)', marginTop: '0.4rem'}}>Figure 16: Confirming that the data link wiring is correct</figcaption>
</figure>
...
<figure style={{textAlign: 'center', margin: '0 0 1rem'}}>
  <img src={require('./images/airylite485/img_v3_02uh_7088f327-d2fe-407b-b5d4-ca30a8d31c4g.png').default} alt="XCOM serial port monitor showing scrolling hexadecimal data from the LiDAR" style={{maxWidth: '600px', width: '100%', height: 'auto'}} />
  <figcaption style={{fontSize: '0.85em', color: 'var(--ifm-color-emphasis-600)', marginTop: '0.4rem'}}>Figure 17: Checking whether the host receives serial port data</figcaption>
</figure>
...
<figure style={{textAlign: 'center', margin: '0 0 1rem'}}>
  <img src={require('./images/airylite485/img_v3_02102_067e8142-39ab-4615-8ba4-f832656ec1dg_1.png').default} alt="Error message caused by invalid characters in the RSView program path on Ubuntu" style={{maxWidth: '600px', width: '100%', height: 'auto'}} />
  <figcaption style={{fontSize: '0.85em', color: 'var(--ifm-color-emphasis-600)', marginTop: '0.4rem'}}>Figure 18: Error caused by invalid characters in the path</figcaption>
</figure>
...
<figure style={{textAlign: 'center', margin: '0 0 1rem'}}>
  <img src={require('./images/airylite485/img_v3_02uh_d43fd878-3e57-4a58-8035-8655cfabd7bg_1.webp').default} alt="LiDAR emitting laser observed with a camera" style={{maxWidth: '600px', width: '100%', height: 'auto'}} />
  <figcaption style={{fontSize: '0.85em', color: 'var(--ifm-color-emphasis-600)', marginTop: '0.4rem'}}>Figure 19: The LiDAR is emitting laser</figcaption>
</figure>

<figure style={{textAlign: 'center', margin: '0 0 1rem'}}>
  <img src={require('./images/airylite485/image_5.png').default} alt="Adapter board with its indicator light on" style={{maxWidth: '600px', width: '100%', height: 'auto'}} />
  <figcaption style={{fontSize: '0.85em', color: 'var(--ifm-color-emphasis-600)', marginTop: '0.4rem'}}>Figure 20: The adapter board indicator is lit</figcaption>
</figure>
...
<figure style={{textAlign: 'center', margin: '0 0 1rem'}}>
  <img src={require('./images/airylite485/image_noext.png').default} alt="Terminal listing showing the generated ch343.ko driver file in the driver directory" style={{maxWidth: '600px', width: '100%', height: 'auto'}} />
  <figcaption style={{fontSize: '0.85em', color: 'var(--ifm-color-emphasis-600)', marginTop: '0.4rem'}}>Figure 21: The generated ch343.ko driver file</figcaption>
</figure>
