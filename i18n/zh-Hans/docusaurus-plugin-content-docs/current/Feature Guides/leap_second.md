...
<figure className="doc-figure">
  <img src={require('./images/leapsecond/image_2.jpg').default} alt="Wireshark 解析 PTPv2 Announce 报文，PTP_TIMESCALE 标志位为 True，originCurrentUTCOffset 为 37" className="doc-figure-img" />
  <figcaption className="doc-figure-caption">图 1：Announce 报文中的 PTP_TIMESCALE 标志位与 originCurrentUTCOffset</figcaption>
</figure>
...
<figure className="doc-figure">
  <img src={require('./images/leapsecond/image_3.jpg').default} alt="linuxptp port.c 源码中在 port_tx_announce 函数内清除 PTP_TIMESCALE 标志位" className="doc-figure-img" />
...
<figure className="doc-figure">
  <img src={require('./images/leapsecond/image_1.jpg').default} alt="驱动源文件 decoder_RSAIRY.hpp 中在通道时间戳计算里加上 37 秒" className="doc-figure-img" />
  <figcaption className="doc-figure-caption">图 4：在驱动端补偿 37 秒</figcaption>
</figure>
